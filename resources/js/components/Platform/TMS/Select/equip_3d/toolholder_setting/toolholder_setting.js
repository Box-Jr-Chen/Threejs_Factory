import panel_toolholder from "./panel_toolholder/panel_toolholder.vue";
import panel_type from "./panel_type/panel_type.vue";
import panel_list from "./panel_list/panel_list.vue";

export default {
    name: 'toolholder_setting',
    components: {
        panel_toolholder,
        panel_type,
        panel_list
